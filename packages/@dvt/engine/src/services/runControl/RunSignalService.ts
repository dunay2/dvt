...
export interface RunSignalServiceDeps {
...
export function buildRunSignalService(deps: RunSignalServiceDeps): IRunSignalService {
  return new RunSignalService(deps);
}
