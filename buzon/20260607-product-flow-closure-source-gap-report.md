...
| Select/import source tables | `ListWarehouseConnections`, `ListWarehouseConnectionTables`, and `ImportWarehouseSources` are implemented-api rails | Needs end-to-end proof from source import to canvas source node and generated graph draft. |
