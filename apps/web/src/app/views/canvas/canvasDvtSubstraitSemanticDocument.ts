/** Owns canonical serialization for every admitted DVT Substrait relation shape. */
...
export function decodeDvtSubstraitSemanticDocument(input: unknown): DvtSubstraitSemanticDraft {
...
export function encodeDvtSubstraitSemanticDocument(
