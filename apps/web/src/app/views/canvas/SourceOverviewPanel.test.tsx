...
const node: CanonicalNode = {
  ...
  metadata: {
    ...
    comment: 'Audit trail maintained by the external database.',
  },
};
      ...
      rows: [
        {
          id: 'comment',
          label: 'Comment',
          value: 'Audit trail maintained by the external database.',
        },
      ],
      tableRows: [],
    },
...
function Harness({ onApply }: Readonly<{ onApply: (draft: CanvasInspectorNodeDraft) => void }>) {
...
describe('SourceOverviewPanel', () => {
  ...
  it('renders external facts and DVT metadata without permanent form or save chrome', () => {
    ...
    expect(container.textContent).toContain('Audit trail maintained by the external database.');
