    ...
    <>
      ...
      <DropdownMenuSub>
        <DropdownMenuSubTrigger>
          ...
          {canvasViewCopy.toolbarCanvasSettingsLabel}
        </DropdownMenuSubTrigger>
        <DropdownMenuSubContent className="w-64">
          ...
          <DropdownMenuCheckboxItem
            checked={contribution.canvasEmptyStateGuideVisible}
            onCheckedChange={contribution.onSetCanvasEmptyStateGuideVisible}
          >
            <BookOpenCheck className="mr-2 size-4" />
            {canvasViewCopy.toolbarEmptyCanvasGuideLabel}
          </DropdownMenuCheckboxItem>
        </DropdownMenuSubContent>
      </DropdownMenuSub>
    </>
