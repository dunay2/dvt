...
/** Owned concern: prove the Canvas PlanRunReadiness UX renders the rail read model. */
...
describe('PlanRunReadinessPanel', () => {
  ...
  it('renders a ready read model with no blockers', () => {
  ...
  it('renders every blocker in the blocked read model', () => {
    renderPanel(
      buildReadiness({
        blockers: [
          'plan_integrity',
