...
describe('Canvas workbench tabs architecture', () => {
  it('documents semantic API, stories, canonical analysis, and owned-concern modules', () => {
    ...
    for (const modulePath of [
      ...
      'views/canvas/canvasWorkbenchLogEntries.ts',
      'views/canvas/CanvasWorkbenchLogPanel.tsx',
      ...
      'views/canvas/canvasWorkbenchLogEntries.test.ts',
      'views/canvas/CanvasWorkbenchLogPanel.test.tsx',
  ...
  it('keeps F-12 Graph retirement semantic instead of reintroducing GraphCanvas naming', () => {
    ...
    expect(routeSource).toContain('params.workbenchTab != null');
