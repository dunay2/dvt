...
export const canvasNodeWorkbenchVisualTokens = Object.freeze({
  ...
  defaultOverlaySize: 'h-[min(40rem,calc(100%-2rem))] w-[min(28rem,calc(100%-2rem))]',
  sourceOverlaySize: 'h-[min(56rem,calc(100%-2rem))] w-[min(52rem,calc(100%-2rem))]',
  relationalOverlaySize: 'h-[min(56rem,calc(100%-2rem))] w-[min(72rem,calc(100%-2rem))]',
  dragHandle:
