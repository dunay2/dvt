...
export const canvasViewAuthoringCopyEs = {
  ...
  inspectorDbtModelSqlLabel: 'Proyección SQL generada',
  inspectorDbtModelSqlGeneratedDetailTemplate:
    'Artefacto DBT generado: {path}. Es una proyección de solo lectura.',
  ...
  inspectorDvtSubstraitLeftJoinRolesHint: 'L conservada · R nullable',
  inspectorDvtSubstraitRightJoinRolesHint: 'L nullable · R conservada',
  inspectorDvtSubstraitFullOuterJoinRolesHint: 'L nullable · R nullable',
  inspectorDvtSubstraitLeftFilteringJoinRolesHint: 'L conservada · R consultada',
  inspectorDvtSubstraitRightFilteringJoinRolesHint: 'L consultada · R conservada',
  inspectorDvtSubstraitInnerJoinTitle: 'INNER JOIN Substrait',
  inspectorDvtSubstraitJoinConditionLabel: 'Condición de unión',
  inspectorDvtSubstraitAppendInputTitle: 'Añadir entrada conectada',
  ...
  inspectorDvtSubstraitUnionDistinctTitle: 'UNION DISTINCT Substrait',
  inspectorDvtSubstraitIntersectDistinctTitle: 'INTERSECT Substrait',
  inspectorDvtSubstraitExceptDistinctTitle: 'EXCEPT Substrait',
  inspectorDvtSubstraitIntersectAllTitle: 'INTERSECT ALL Substrait',
  inspectorDvtSubstraitExceptAllTitle: 'EXCEPT ALL Substrait',
  inspectorDvtSubstraitUnionAllInputsLabel: 'Entradas',
  inspectorDvtSubstraitUnionAllFieldsLabel: 'Campos compatibles',
  inspectorDvtRelationalOperationTitle: 'Relacionar / componer',
  inspectorDvtRelationalAvailable: 'Disponible',
  inspectorDvtRelationalNeedsPredicate: 'Necesita condición',
  inspectorDvtRelationalNeedsSchemaAlignment: 'Necesita alinear columnas',
  inspectorDvtRelationalTargetUnavailable: 'Destino no disponible',
  inspectorDvtRelationalUnavailable: 'No disponible',
  ...
  relationalTreeDropSourceMessage: 'Arrastra una Fuente aquí.',
  relationalTreePendingInputsMessage: 'Entradas disponibles',
  relationalTreeParticipatingLabel: 'Participa',
  relationalTreePendingLabel: 'Pendiente',
  relationalTreeMissingLabel: 'Ausente',
  relationalTreeOutputLabel: 'Salida',
  relationalTreePrimaryInputLabel: 'Entrada principal',
  ...
  relationalTreeReadOnlyMessage:
    'Solo inspección. Los cambios usan los controles existentes de la operación.',
  relationalTreeUnavailableMessage: 'No hay un árbol relacional canónico disponible.',
  relationalTreeInvalidMessage: 'No se pudo leer el árbol relacional canónico.',
  relationalTreeInputIdentityUnavailableMessage: 'Una Fuente conectada no tiene identidad estable.',
  relationalTreeSelectFirstSourceMessage: 'Selecciona la primera Fuente.',
  relationalTreeSelectOperationMessage: 'Selecciona una operación relacional.',
  relationalTreeSelectNextSourceMessage: 'Añade una segunda Fuente para habilitar JOIN o UNION.',
  relationalTreeSourceActionHint: 'Arrastra o pulsa para añadir',
  relationalTreeSelectedInputsLabel: 'Entradas seleccionadas',
  ...
  inspectorDvtSubstraitGrainFieldLabel: 'Campo de granularidad',
  inspectorDvtSubstraitCountOutputLabel: 'Salida del conteo de filas',
  inspectorDvtSubstraitApplyAggregationLabel: 'Resumir',
  inspectorDvtSubstraitRemoveAggregationLabel: 'Quitar resumen',
  inspectorDvtSubstraitAggregateWindowTitle: 'Clasificar filas agrupadas',
  inspectorDvtSubstraitAggregateWindowOrderLabel: 'Ordenar filas agrupadas por',
  inspectorDvtSubstraitApplyAggregateWindowLabel: 'Clasificar grupos',
  inspectorDvtSubstraitRemoveAggregateWindowLabel: 'Quitar clasificación de grupos',
  inspectorDvtSubstraitWindowTitle: 'Relación contextual',
  inspectorDvtSubstraitWindowInputLabel: 'Misma entrada',
  inspectorDvtSubstraitWindowPartitionFieldLabel: 'Campo de partición',
  inspectorDvtSubstraitWindowOrderFieldLabel: 'Campo de orden',
  inspectorDvtSubstraitWindowOrderDirectionLabel: 'ASC · NULOS AL FINAL',
  inspectorDvtSubstraitWindowFrameLabel: 'Marco',
  inspectorDvtSubstraitWindowFrameUnspecifiedLabel: 'Sin especificar',
  inspectorDvtSubstraitWindowOperationLabel: 'Posición relativa',
  inspectorDvtSubstraitWindowOutputLabel: 'Salida del número de fila',
  inspectorDvtSubstraitApplyWindowLabel: 'Añadir números de fila',
  inspectorDvtSubstraitRemoveWindowLabel: 'Quitar números de fila',
