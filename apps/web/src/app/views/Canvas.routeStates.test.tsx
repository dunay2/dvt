...
describe('Canvas route states', () => {
  ...
  it('proves typed transformation canvas continuation from authoring into preview and run', async () => {
    ...
    const initialButtons = getPrimaryCanvasButtons(harness.container);
    expect(initialButtons.planButton?.getAttribute('disabled')).toBeNull();
    expect(initialButtons.runButton?.getAttribute('disabled')).not.toBeNull();

    initialButtons.planButton?.click();
    await harness.render();
    ...
    const readyButtons = getPrimaryCanvasButtons(harness.container);
    expect(readyButtons.runButton?.getAttribute('disabled')).toBeNull();

    readyButtons.runButton?.click();
