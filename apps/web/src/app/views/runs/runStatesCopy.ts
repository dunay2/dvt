...
const RUN_STATES_COPY_EN = {
  ...
  runDetailSectionsLabel: 'Run detail sections',
  runSummaryTabLabel: 'Summary',
  runResultTabLabel: 'Result',
  runProvenanceTabLabel: 'Provenance',
  runDiagnosticsEventsTabLabel: 'Diagnostics and events',
  ...
  dvtPublicationTitle: 'PostgreSQL publication evidence',
  dvtPublicationTargetLabel: 'Published target',
  dvtPublicationOutcomeLabel: 'Publication outcome',
  dvtPublicationTokenLabel: 'Publication token',
  dvtPublicationOutcomeLabels: {
    created: 'Created',
    replaced: 'Replaced',
...
const RUN_STATES_COPY_ES = {
  ...
  runDetailSectionsLabel: 'Secciones del detalle de la ejecución',
  runSummaryTabLabel: 'Resumen',
  runResultTabLabel: 'Resultado',
  runProvenanceTabLabel: 'Procedencia',
  runDiagnosticsEventsTabLabel: 'Diagnóstico y eventos',
  ...
  dvtPublicationTitle: 'Evidencia de publicación PostgreSQL',
  dvtPublicationTargetLabel: 'Destino publicado',
  dvtPublicationOutcomeLabel: 'Resultado de la publicación',
  dvtPublicationTokenLabel: 'Token de publicación',
  dvtPublicationOutcomeLabels: {
    created: 'Creado',
    replaced: 'Reemplazado',
    'verified-existing': 'Existente verificado',
  },
