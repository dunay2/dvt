...
const EN_COPY = {
  ...
  metadata: {
    ...
    activeDescription: 'Inspect the active source object before selecting it.',
    ...
    globalOptionsTitle: 'Apply to all selected sources',
    globalOptionsDescription: 'These choices affect the complete source selection.',
...
const ES_COPY = {
  ...
  metadata: {
    ...
    activeDescription: 'Inspecciona el objeto de origen activo antes de seleccionarlo.',
    title: 'Metadatos del origen: todos los seleccionados',
    ...
    globalOptionsTitle: 'Aplicar a todos los orígenes seleccionados',
    globalOptionsDescription: 'Estas decisiones afectan a toda la selección de orígenes.',
