...
export const PROTECTED_RUNTIME_ROUTE_SUMMARY = [
  ...
  `GET ${RUNTIME_ROUTE_PATH.dbtSelectedModelAnalysis}`,
  `POST ${RUNTIME_ROUTE_PATH.dbtDependencyEditApplications}`,
  `POST ${RUNTIME_ROUTE_PATH.graphDbtWorkspaceArtifactPublications}`,
