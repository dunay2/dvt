---
title: Temporal SDK 1.17.2 upgrade
status: Accepted
date: 2026-06-03
owners:
...
# Temporal SDK 1.17.2 Upgrade

## Summary

PR #1098 upgrades the Temporal TypeScript SDK packages used by the Temporal
adapter and Temporal worker from `1.16.1` to `1.17.2`.

The repository change is limited to dependency metadata and the lockfile. It
does not change adapter source code, workflow definitions, public DVT
