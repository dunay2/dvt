...
| [Documentation Usability Change Plan](documentation-usability-change-plan-20260308.md)                      | Documentation governance plan      | How should the documentation system become usable and governable?                              |
...
| [CI Workflow Deduplication Plan](ci-workflow-deduplication-plan-20260307.md)                                | Enforcement and orchestration plan | How should CI and repository automation enforce and reuse repository rules?                    |
...
2. [Documentation Usability Change Plan](documentation-usability-change-plan-20260308.md)
3. [Package Module Build Policy v2](package-module-build-policy-v2-20260317.md)
4. [CI Workflow Deduplication Plan](ci-workflow-deduplication-plan-20260307.md)
