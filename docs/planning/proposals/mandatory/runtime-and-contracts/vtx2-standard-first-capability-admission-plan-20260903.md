...
symbols: [
  ...
  {<<: *symbolDefaults, name: LOWER_ID, path: packages/@dvt/contracts/src/contracts/planner/DvtSubstraitSupportedCapabilities.v1.ts}, {<<: *symbolDefaults, name: PILOT_IDS, path: packages/@dvt/contracts/src/contracts/planner/DvtSubstraitSupportedCapabilities.v1.ts},
  {<<: *symbolDefaults, name: JOIN_IDS, path: packages/@dvt/contracts/src/contracts/planner/DvtSubstraitSupportedCapabilities.v1.ts}, {<<: *symbolDefaults, name: AGGREGATE_IDS, path: packages/@dvt/contracts/src/contracts/planner/DvtSubstraitSupportedCapabilities.v1.ts},
  {<<: *symbolDefaults, name: WINDOW_IDS, path: packages/@dvt/contracts/src/contracts/planner/DvtSubstraitSupportedCapabilities.v1.ts}, {<<: *symbolDefaults, name: CALCULATED_IDS, path: packages/@dvt/contracts/src/contracts/planner/DvtSubstraitSupportedCapabilities.v1.ts},
  {<<: *symbolDefaults, name: UNION_ALL_IDS, path: packages/@dvt/contracts/src/contracts/planner/DvtSubstraitSupportedCapabilities.v1.ts}, {<<: *symbolDefaults, name: featureRefs, path: packages/@dvt/contracts/src/contracts/planner/DvtSubstraitSupportedCapabilities.v1.ts},
  {<<: *symbolDefaults, name: proofRef, path: packages/@dvt/contracts/src/contracts/planner/DvtSubstraitSupportedCapabilities.v1.ts}, {<<: *symbolDefaults, name: admissionFor, path: packages/@dvt/contracts/src/contracts/planner/DvtSubstraitSupportedCapabilities.v1.ts},
