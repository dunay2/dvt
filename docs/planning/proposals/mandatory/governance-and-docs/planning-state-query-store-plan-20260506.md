...
redGreenCycles:
  ...
  - id: planning-db-next-task-claim-boundary
    ...
    expectedFailure: planning_next_tasks still includes queued rows that carry active or stale claim fields, mixing recovery work with clean next-task selection.
    patchSurfaces:
