...
| The user needs a professional flow order before development continues.                                      | Responsibility overload                   | Prioritized planning surface        | Frontend GitHub issue planning            | Planning review, no runtime mutation            | Review priority matrix                                                    | Review with user before implementation            | Committing to every P2 hardening item |
