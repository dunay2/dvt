...
| persisted DBT plans start without a plugin run context.                      | Hidden runtime dependency                | Gateway-backed application policy | `DbtRunExecutionContextBindingUseCase` | `StartRun`                                                  | `DbtRunExecutionContextBindingUseCase.ts`, `buildProtectedStartRunRuntime.ts`, `buildProtectedRuntimeStorage.ts`, `run-dev-stack.cjs`                | `DbtRunExecutionContextBindingUseCase.test.ts`, `run-dev-stack.test.cjs`  | `startRunRuntimeComposition.cases.ts`                    | `canvas-dbt-author-code-run-live.cy.ts` | contract or engine changes         |
...
allowedImplementationSurfaces:
  ...
  - tools/planning-db/migrations/627_dbt_runtime_bundle_secret_boundary.sql
  - tools/planning-db/migrations/628_dbt_runtime_bundle_secret_boundary_evidence.sql
  - tools/planning-db/migrations/629_dbt_runtime_bundle_component_projection_refresh.sql
  - tools/planning-db/migrations/630_dbt_runtime_profile_admission.sql
  - tools/planning-db/migrations/631_dbt_runtime_profile_admission_evidence.sql
  - tools/planning-db/migrations/632_dbt_runtime_context_ref_provenance.sql
  - tools/planning-db/migrations/633_dbt_runtime_context_ref_provenance_evidence.sql
...
symbols:
  ...
  - { name: DEFAULT_LOCAL_DBT_BUNDLE_FILE_ROOT, path: scripts/run-dev-stack.cjs, dddOwner: DbtRunExecutionContextBindingUseCase, cqRails: [StartRun], fowlerSignals: [Hidden runtime dependency], architectureGuard: pnpm docs:feature-mechanization:implementation, cypressCoverage: apps/web/cypress/e2e/canvas/canvas-dbt-author-code-run-live.cy.ts, unitTests: [scripts/run-dev-stack.test.cjs] }
  ...
  - { name: DBT_EXECUTABLE_STEP_KINDS, path: apps/api/src/application/services/DbtRunExecutionContextBindingUseCase.ts, dddOwner: DbtAuthoringRunVertical, cqRails: [ConfigureCanvasDbtNode, SelectDbtModelOrigin, GenerateDbtWorkspaceArtifacts, BuildDbtPlannerGraphSource, PreviewExecutablePlan, StartRun], fowlerSignals: [Hidden authority], architectureGuard: pnpm docs:feature-mechanization:implementation, cypressCoverage: apps/web/cypress/e2e/canvas/canvas-dbt-author-code-run-live.cy.ts, unitTests: [apps/web/src/app/views/canvas/useCanvasExecutionActions.dbt.test.tsx] }
  ...
  - { name: inspectDbtWorkspaceBundle, path: apps/api/src/application/services/DbtRunExecutionContextBindingUseCase.ts, dddOwner: DbtAuthoringRunVertical, cqRails: [ConfigureCanvasDbtNode, SelectDbtModelOrigin, GenerateDbtWorkspaceArtifacts, BuildDbtPlannerGraphSource, PreviewExecutablePlan, StartRun], fowlerSignals: [Hidden authority], architectureGuard: pnpm docs:feature-mechanization:implementation, cypressCoverage: apps/web/cypress/e2e/canvas/canvas-dbt-author-code-run-live.cy.ts, unitTests: [apps/web/src/app/views/canvas/useCanvasExecutionActions.dbt.test.tsx] }
  ...
  - { name: DbtWorkspaceBundleInspection, path: apps/api/src/application/services/DbtRunExecutionContextBindingUseCase.ts, dddOwner: DbtRunExecutionContextBindingUseCase, cqRails: [StartRun], fowlerSignals: [Boundary drift], architectureGuard: pnpm --filter dvt-api exec vitest run --config vitest.config.ts test/application/services/DbtRunExecutionContextBindingUseCase.bundleSecurity.test.ts, cypressCoverage: not_applicable, unitTests: [apps/api/test/application/services/DbtRunExecutionContextBindingUseCase.bundleSecurity.test.ts] }
  - { name: DBT_CALLER_CONTEXT_REF_REJECTION_REASON, path: apps/api/src/application/services/DbtRunExecutionContextBindingUseCase.ts, dddOwner: DbtRunExecutionContextBindingUseCase, cqRails: [StartRun], fowlerSignals: [Boundary drift], architectureGuard: pnpm --filter dvt-api exec vitest run --config vitest.config.ts test/application/services/DbtRunExecutionContextBindingUseCase.bundleSecurity.test.ts, cypressCoverage: not_applicable, unitTests: [apps/api/test/application/services/DbtRunExecutionContextBindingUseCase.bundleSecurity.test.ts] }
  - { name: DBT_PROFILE_FILENAMES, path: apps/api/src/application/services/DbtRunExecutionContextBindingUseCase.ts, dddOwner: DbtRunExecutionContextBindingUseCase, cqRails: [StartRun], fowlerSignals: [Boundary drift], architectureGuard: pnpm --filter dvt-api exec vitest run --config vitest.config.ts test/application/services/DbtRunExecutionContextBindingUseCase.bundleSecurity.test.ts, cypressCoverage: not_applicable, unitTests: [apps/api/test/application/services/DbtRunExecutionContextBindingUseCase.bundleSecurity.test.ts] }
  - { name: DBT_WORKSPACE_PROFILE_REJECTION_REASON, path: apps/api/src/application/services/DbtRunExecutionContextBindingUseCase.ts, dddOwner: DbtRunExecutionContextBindingUseCase, cqRails: [StartRun], fowlerSignals: [Boundary drift], architectureGuard: pnpm --filter dvt-api exec vitest run --config vitest.config.ts test/application/services/DbtRunExecutionContextBindingUseCase.bundleSecurity.test.ts, cypressCoverage: not_applicable, unitTests: [apps/api/test/application/services/DbtRunExecutionContextBindingUseCase.bundleSecurity.test.ts] }
  - { name: isDbtProfilePath, path: apps/api/src/application/services/DbtRunExecutionContextBindingUseCase.ts, dddOwner: DbtRunExecutionContextBindingUseCase, cqRails: [StartRun], fowlerSignals: [Boundary drift], architectureGuard: pnpm --filter dvt-api exec vitest run --config vitest.config.ts test/application/services/DbtRunExecutionContextBindingUseCase.bundleSecurity.test.ts, cypressCoverage: not_applicable, unitTests: [apps/api/test/application/services/DbtRunExecutionContextBindingUseCase.bundleSecurity.test.ts] }
  - { name: tempRoots, path: apps/api/test/application/services/DbtRunExecutionContextBindingUseCase.bundleSecurity.test.ts, dddOwner: DbtRunExecutionContextBindingUseCaseTestEvidence, cqRails: [StartRun], fowlerSignals: [Boundary drift], architectureGuard: pnpm --filter dvt-api exec vitest run --config vitest.config.ts test/application/services/DbtRunExecutionContextBindingUseCase.bundleSecurity.test.ts, cypressCoverage: not_applicable, unitTests: [apps/api/test/application/services/DbtRunExecutionContextBindingUseCase.bundleSecurity.test.ts] }
  - { name: executeBinding, path: apps/api/test/application/services/DbtRunExecutionContextBindingUseCase.bundleSecurity.test.ts, dddOwner: DbtRunExecutionContextBindingUseCaseTestEvidence, cqRails: [StartRun], fowlerSignals: [Boundary drift], architectureGuard: pnpm --filter dvt-api exec vitest run --config vitest.config.ts test/application/services/DbtRunExecutionContextBindingUseCase.bundleSecurity.test.ts, cypressCoverage: not_applicable, unitTests: [apps/api/test/application/services/DbtRunExecutionContextBindingUseCase.bundleSecurity.test.ts] }
  - { name: makeTempRoot, path: apps/api/test/application/services/DbtRunExecutionContextBindingUseCase.bundleSecurity.test.ts, dddOwner: DbtRunExecutionContextBindingUseCaseTestEvidence, cqRails: [StartRun], fowlerSignals: [Boundary drift], architectureGuard: pnpm --filter dvt-api exec vitest run --config vitest.config.ts test/application/services/DbtRunExecutionContextBindingUseCase.bundleSecurity.test.ts, cypressCoverage: not_applicable, unitTests: [apps/api/test/application/services/DbtRunExecutionContextBindingUseCase.bundleSecurity.test.ts] }
  - { name: writeWorkspaceFiles, path: apps/api/test/application/services/DbtRunExecutionContextBindingUseCase.bundleSecurity.test.ts, dddOwner: DbtRunExecutionContextBindingUseCaseTestEvidence, cqRails: [StartRun], fowlerSignals: [Boundary drift], architectureGuard: pnpm --filter dvt-api exec vitest run --config vitest.config.ts test/application/services/DbtRunExecutionContextBindingUseCase.bundleSecurity.test.ts, cypressCoverage: not_applicable, unitTests: [apps/api/test/application/services/DbtRunExecutionContextBindingUseCase.bundleSecurity.test.ts] }
  - { name: buildDbtPlanBytes, path: apps/api/test/application/services/DbtRunExecutionContextBindingUseCase.bundleSecurity.test.ts, dddOwner: DbtRunExecutionContextBindingUseCaseTestEvidence, cqRails: [StartRun], fowlerSignals: [Boundary drift], architectureGuard: pnpm --filter dvt-api exec vitest run --config vitest.config.ts test/application/services/DbtRunExecutionContextBindingUseCase.bundleSecurity.test.ts, cypressCoverage: not_applicable, unitTests: [apps/api/test/application/services/DbtRunExecutionContextBindingUseCase.bundleSecurity.test.ts] }
  - { name: buildCommand, path: apps/api/test/application/services/DbtRunExecutionContextBindingUseCase.bundleSecurity.test.ts, dddOwner: DbtRunExecutionContextBindingUseCaseTestEvidence, cqRails: [StartRun], fowlerSignals: [Boundary drift], architectureGuard: pnpm --filter dvt-api exec vitest run --config vitest.config.ts test/application/services/DbtRunExecutionContextBindingUseCase.bundleSecurity.test.ts, cypressCoverage: not_applicable, unitTests: [apps/api/test/application/services/DbtRunExecutionContextBindingUseCase.bundleSecurity.test.ts] }
  - { name: buildContext, path: apps/api/test/application/services/DbtRunExecutionContextBindingUseCase.bundleSecurity.test.ts, dddOwner: DbtRunExecutionContextBindingUseCaseTestEvidence, cqRails: [StartRun], fowlerSignals: [Boundary drift], architectureGuard: pnpm --filter dvt-api exec vitest run --config vitest.config.ts test/application/services/DbtRunExecutionContextBindingUseCase.bundleSecurity.test.ts, cypressCoverage: not_applicable, unitTests: [apps/api/test/application/services/DbtRunExecutionContextBindingUseCase.bundleSecurity.test.ts] }
```
