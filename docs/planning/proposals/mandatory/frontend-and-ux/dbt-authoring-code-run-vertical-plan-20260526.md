...
symbols:
  ...
  - { name: executeBindingAndReadBundleEntries, path: apps/api/test/application/services/DbtRunExecutionContextBindingUseCase.bundleSecurity.test.ts, dddOwner: DbtRunExecutionContextBindingUseCaseTestEvidence, cqRails: [StartRun], fowlerSignals: [Boundary drift], architectureGuard: pnpm --filter dvt-api exec vitest run --config vitest.config.ts test/application/services/DbtRunExecutionContextBindingUseCase.bundleSecurity.test.ts, cypressCoverage: not_applicable, unitTests: [apps/api/test/application/services/DbtRunExecutionContextBindingUseCase.bundleSecurity.test.ts] }
  ...
  - { name: readTarFileEntries, path: apps/api/test/application/services/DbtRunExecutionContextBindingUseCase.bundleSecurity.test.ts, dddOwner: DbtRunExecutionContextBindingUseCaseTestEvidence, cqRails: [StartRun], fowlerSignals: [Boundary drift], architectureGuard: pnpm --filter dvt-api exec vitest run --config vitest.config.ts test/application/services/DbtRunExecutionContextBindingUseCase.bundleSecurity.test.ts, cypressCoverage: not_applicable, unitTests: [apps/api/test/application/services/DbtRunExecutionContextBindingUseCase.bundleSecurity.test.ts] }
  - { name: readTarString, path: apps/api/test/application/services/DbtRunExecutionContextBindingUseCase.bundleSecurity.test.ts, dddOwner: DbtRunExecutionContextBindingUseCaseTestEvidence, cqRails: [StartRun], fowlerSignals: [Boundary drift], architectureGuard: pnpm --filter dvt-api exec vitest run --config vitest.config.ts test/application/services/DbtRunExecutionContextBindingUseCase.bundleSecurity.test.ts, cypressCoverage: not_applicable, unitTests: [apps/api/test/application/services/DbtRunExecutionContextBindingUseCase.bundleSecurity.test.ts] }
```
