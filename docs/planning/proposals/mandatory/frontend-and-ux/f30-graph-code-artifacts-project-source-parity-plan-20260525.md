...
symbols:
  ...
  - { name: ExecutableSqlResolution, path: apps/web/src/app/views/canvas/canvasTransformationSqlMirror.ts, dddOwner: TransformationWorkspaceArtifactProjection, cqRails: [GenerateTransformationWorkspaceArtifacts], fowlerSignals: [Hidden authority], architectureGuard: pnpm docs:feature-mechanization:implementation -- --feature F30-GRAPH-CODE-ARTIFACTS-PARITY-20260525, cypressCoverage: N/A - unit mirror proof, unitTests: [pnpm --filter @dvt/web exec vitest run --config vitest.config.ts src/app/views/canvas/canvasTransformationSqlMirror.test.ts] }
  - { name: TransformationSqlMirrorState, path: apps/web/src/app/views/canvas/canvasTransformationSqlMirror.ts, dddOwner: TransformationWorkspaceArtifactProjection, cqRails: [GenerateTransformationWorkspaceArtifacts], fowlerSignals: [Hidden authority], architectureGuard: pnpm docs:feature-mechanization:implementation -- --feature F30-GRAPH-CODE-ARTIFACTS-PARITY-20260525, cypressCoverage: N/A - unit mirror proof, unitTests: [pnpm --filter @dvt/web exec vitest run --config vitest.config.ts src/app/views/canvas/canvasTransformationSqlMirror.test.ts] }
  - { name: TransformationSqlMirrorStatus, path: apps/web/src/app/views/canvas/canvasTransformationSqlMirror.ts, dddOwner: TransformationWorkspaceArtifactProjection, cqRails: [GenerateTransformationWorkspaceArtifacts], fowlerSignals: [Hidden authority], architectureGuard: pnpm docs:feature-mechanization:implementation -- --feature F30-GRAPH-CODE-ARTIFACTS-PARITY-20260525, cypressCoverage: N/A - unit mirror proof, unitTests: [pnpm --filter @dvt/web exec vitest run --config vitest.config.ts src/app/views/canvas/canvasTransformationSqlMirror.test.ts] }
  - { name: buildDvtSqlTransformMetadata, path: apps/web/src/app/views/canvas/canvasTransformationSqlMirror.ts, dddOwner: TransformationWorkspaceArtifactProjection, cqRails: [GenerateTransformationWorkspaceArtifacts], fowlerSignals: [Boundary drift, Hidden authority], architectureGuard: pnpm docs:feature-mechanization:implementation -- --feature F30-GRAPH-CODE-ARTIFACTS-PARITY-20260525, cypressCoverage: N/A - unit mirror proof, unitTests: [pnpm --filter @dvt/web exec vitest run --config vitest.config.ts src/app/views/canvas/canvasTransformationSqlMirror.test.ts] }
  - { name: readCompiledSqlText, path: apps/web/src/app/views/canvas/canvasTransformationSqlMirror.ts, dddOwner: TransformationWorkspaceArtifactProjection, cqRails: [GenerateTransformationWorkspaceArtifacts], fowlerSignals: [Hidden authority], architectureGuard: pnpm docs:feature-mechanization:implementation -- --feature F30-GRAPH-CODE-ARTIFACTS-PARITY-20260525, cypressCoverage: N/A - unit mirror proof, unitTests: [pnpm --filter @dvt/web exec vitest run --config vitest.config.ts src/app/views/canvas/canvasTransformationSqlMirror.test.ts] }
  - { name: readDraftSqlText, path: apps/web/src/app/views/canvas/canvasTransformationSqlMirror.ts, dddOwner: TransformationWorkspaceArtifactProjection, cqRails: [GenerateTransformationWorkspaceArtifacts], fowlerSignals: [Hidden authority], architectureGuard: pnpm docs:feature-mechanization:implementation -- --feature F30-GRAPH-CODE-ARTIFACTS-PARITY-20260525, cypressCoverage: N/A - unit mirror proof, unitTests: [pnpm --filter @dvt/web exec vitest run --config vitest.config.ts src/app/views/canvas/canvasTransformationSqlMirror.test.ts] }
  - { name: readMetadataConfig, path: apps/web/src/app/views/canvas/canvasTransformationSqlMirror.ts, dddOwner: TransformationWorkspaceArtifactProjection, cqRails: [GenerateTransformationWorkspaceArtifacts], fowlerSignals: [Primitive obsession], architectureGuard: pnpm docs:feature-mechanization:implementation -- --feature F30-GRAPH-CODE-ARTIFACTS-PARITY-20260525, cypressCoverage: N/A - unit mirror proof, unitTests: [pnpm --filter @dvt/web exec vitest run --config vitest.config.ts src/app/views/canvas/canvasTransformationSqlMirror.test.ts] }
  - { name: readString, path: apps/web/src/app/views/canvas/canvasTransformationSqlMirror.ts, dddOwner: TransformationWorkspaceArtifactProjection, cqRails: [GenerateTransformationWorkspaceArtifacts], fowlerSignals: [Primitive obsession], architectureGuard: pnpm docs:feature-mechanization:implementation -- --feature F30-GRAPH-CODE-ARTIFACTS-PARITY-20260525, cypressCoverage: N/A - unit mirror proof, unitTests: [pnpm --filter @dvt/web exec vitest run --config vitest.config.ts src/app/views/canvas/canvasTransformationSqlMirror.test.ts] }
  - { name: readTransformationSqlMirrorState, path: apps/web/src/app/views/canvas/canvasTransformationSqlMirror.ts, dddOwner: TransformationWorkspaceArtifactProjection, cqRails: [GenerateTransformationWorkspaceArtifacts], fowlerSignals: [Hidden authority], architectureGuard: pnpm docs:feature-mechanization:implementation -- --feature F30-GRAPH-CODE-ARTIFACTS-PARITY-20260525, cypressCoverage: N/A - unit mirror proof, unitTests: [pnpm --filter @dvt/web exec vitest run --config vitest.config.ts src/app/views/canvas/canvasTransformationSqlMirror.test.ts] }
  - { name: resolveExecutableSqlText, path: apps/web/src/app/views/canvas/canvasTransformationSqlMirror.ts, dddOwner: TransformationWorkspaceArtifactProjection, cqRails: [GenerateTransformationWorkspaceArtifacts], fowlerSignals: [Hidden authority], architectureGuard: pnpm docs:feature-mechanization:implementation -- --feature F30-GRAPH-CODE-ARTIFACTS-PARITY-20260525, cypressCoverage: N/A - unit mirror proof, unitTests: [pnpm --filter @dvt/web exec vitest run --config vitest.config.ts src/app/views/canvas/canvasTransformationSqlMirror.test.ts] }
