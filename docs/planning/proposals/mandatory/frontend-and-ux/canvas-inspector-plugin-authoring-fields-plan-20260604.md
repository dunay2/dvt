...
symbols:
  ...
  - { name: DvtTransformAuthoringMetadata, path: apps/web/src/app/views/canvas/DvtAuthoringFields.tsx, dddOwner: DVT Transform materialization presentation DTO, cqRails: [ConfigureCanvasDvtNode], fowlerSignals: [Replace Type Code with Explicit Type], architectureGuard: pnpm docs:feature-mechanization:implementation -- --feature CANVAS-INSPECTOR-PLUGIN-AUTHORING-FIELDS-20260604, cypressCoverage: apps/web/cypress/e2e/canvas/canvas-ready-node-authoring.cy.ts, unitTests: [apps/web/src/app/views/canvas/DvtAuthoringFields.test.tsx] }
  - { name: DvtTransformMaterializationField, path: apps/web/src/app/views/canvas/DvtAuthoringFields.tsx, dddOwner: DVT Transform materialization presentation, cqRails: [ConfigureCanvasDvtNode], fowlerSignals: [Extract Component], architectureGuard: pnpm docs:feature-mechanization:implementation -- --feature CANVAS-INSPECTOR-PLUGIN-AUTHORING-FIELDS-20260604, cypressCoverage: apps/web/cypress/e2e/canvas/canvas-ready-node-authoring.cy.ts, unitTests: [apps/web/src/app/views/canvas/DvtAuthoringFields.test.tsx] }
