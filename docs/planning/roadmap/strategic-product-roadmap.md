...
| Truthful admission and runtime execution | The system must only admit executable plans and expose runtime evidence at the protected boundary.                        | [API and Admission domain](../domains/api-and-admission.md), [Execution Runtime domain](../domains/execution-runtime.md), `TF-C1`, `TF-C2`, `WE-HX` | In progress     | PostgreSQL executor wiring and caller-visible runtime evidence remain open follow-up work.                             |
