...
snapshot; live execution truth now belongs to GitHub Issues. Review documents
remain historical/reference evidence unless a current issue explicitly routes
to them.
