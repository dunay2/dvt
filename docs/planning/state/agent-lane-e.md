...
- `F-03` remains the active shell-health slice, but the 2026-04-02 hard QA review split its remaining closure work into `F-03-A`, `F-03-B`, and `F-03-C`.
