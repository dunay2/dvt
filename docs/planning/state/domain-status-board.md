...
| ------------------------------- | ----------------------------------------------------------------------------------------------------------- | -------------------------------------------------------------------------------------------------------------------------------------------- | --------------------------------------------------------------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `Execution Runtime`             | Close correctness fixes, state-store split, and ADR-0039 extraction backlog with explicit dependency chain. | `RC-A1`, `RC-A2`, `RC-A5`, `RC-A6`, `RC-D2`, `RC-D3`, `F1`, `F4`, `F5`, `S02`, `S03`, `S05`, `S07`, `S12`, `S13`, `S14`, `S15`, `S16`, `S17` | [Execution Runtime lane](../roadmap/roadmap-by-domain.md)             | `S02` full sweep gated by `RC-A6`; `S03` depends on `S02`; `F1` C2 closure depends on `S03`; `S16` depends on `RC-A4`; `S12` waits on `S02`; `S11` waits on `S07` |
