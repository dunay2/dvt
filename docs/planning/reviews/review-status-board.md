...
| [20260402 F-03 shell health Fowler hard review](architecture-and-governance/20260402-f03-shell-health-fowler-hard-review.md)                    | `architecture-and-governance`     | active frontend shell hard-QA and fix-plan intake      | `F-03`                                     | `in_progress`    | `35%`              |
