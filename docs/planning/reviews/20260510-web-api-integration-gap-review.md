...
| Warehouse source import | `listWarehouseConnections`, `listSourceObjects`, `importSources`              | Protected source-object discovery and import rails are implemented               | Provider coverage remains dependent on configured connection adapters       |
