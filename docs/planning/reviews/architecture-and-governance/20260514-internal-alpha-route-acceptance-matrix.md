...
This does not accept alpha full: plan/run readiness and recovery stage evidence
remain planned until their browser/runtime proof is accepted.
...
context, Canvas, and Code now have accepted stage evidence while plan/run
