...
| ------------------- | -------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------- | --------------------------------------------------------------------------------------------------- | ---------------------------------------------------------------------- |
| `SQL-CANVAS-UX-001` | P0       | From an empty SQL Canvas, open a source explorer and browse available warehouse connections, schemas, and tables without typing names.                         | Explorer currently renders existing project resources; `Insert` creates node kinds; source import exists as a wizard but is not a SQL graph source-selection workflow.  | `ListWarehouseConnections`, `ListWarehouseConnectionSourceObjects`, `ListProjectWorkspaceResources` | Cypress flow plus `SourceImportWizard` and explorer presentation tests |
