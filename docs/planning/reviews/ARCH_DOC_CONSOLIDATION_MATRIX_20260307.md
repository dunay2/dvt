...
| `docs/concepts/repository-map.md`                                         | Repository map and code entry points             | `docs/architecture/atlas/architecture/architecture_atlas.md`                                                       | Maintain | Low-risk overlap: it maps code structure rather than architecture status.                                                        | Keep as a concepts/onboarding document.                                                     |
