...
- `pnpm exec markdownlint-cli2 docs/contracts/planner/transformation-flow-compiler-v1.md docs/contracts/planner/transformation-flow-preview-v1.md docs/architecture/components/planner/index.md docs/architecture/system-delivery-status.md docs/planning/roadmap/roadmap-by-domain.md docs/planning/state/domain-status-board.md docs/planning/closeouts/index.md docs/planning/closeouts/20260414-tf-a1-b-compiler-mapping-closeout.md docs/evidence/ED-20260414-tf-a1-b-compiler-mapping-freeze.md --config .markdownlint-cli2.jsonc` - PASS
