...
| `docs/evidence/critical/ED-20260315-adapter-postgres-phase1-items5-7.md`          | Record extraction evidence and validation                          | Tie the slice to explicit proof                                               |
...
- [x] `docs/evidence/critical/ED-20260315-adapter-postgres-phase1-items5-7.md` - extracted-store evidence aligned with the shipped slice
