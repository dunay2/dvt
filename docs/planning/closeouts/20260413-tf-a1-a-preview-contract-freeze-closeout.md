...
| `docs/contracts/planner/transformation-flow-preview-v1.md`                                                                                                                                             | added repo-local reader for the new planner contract pair                 | make the shipped boundary discoverable from docs                                             |
| [Freeze TF-A1-A SQL-first preview and design-graph contract](https://github.com/dunay2/dvt/blob/7bb1b3e39efaf8df701db02dbdf2b10c763cfd28/docs/evidence/ED-20260413-tf-a1-a-preview-contract-freeze.md) | added ARC-2 evidence                                                      | provide governed proof for the contract change                                               |
