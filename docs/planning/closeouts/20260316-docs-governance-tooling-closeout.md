...
| `docs/evidence/ED-20260316-g7-closeout.md`                    | Added required evidence frontmatter keys and normalized evidence status                                                                           | Make newly-governed G7 evidence pass the same frontmatter contract enforced by the new tooling           |
| `docs/evidence/ED-20260316-g7-provider-ref-reconciliation.md` | Added required evidence frontmatter keys and normalized evidence status                                                                           | Same baseline evidence hardening for the G7.3 sub-slice                                                  |
