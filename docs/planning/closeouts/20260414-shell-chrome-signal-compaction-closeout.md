...
| `docs/architecture/components/web/appshell/shell-baseline-target-guide.md`, `docs/planning/closeouts/20260414-shell-chrome-signal-compaction-closeout.md`                            | Brought the shell architecture guide into line with the active workbench contracts and recorded the rationale plus evidence for this slice.                       | Avoid leaving architecture and implementation in conflict for the shell cleanup work. |
