...
| `docs/architecture/components/engine/adapters/state-store/postgres/StateStoreAdapter.md`                    | Updated physical-object guidance for partitioned `run_events`.                                                                       | Remove documentation drift.                                                                 |
