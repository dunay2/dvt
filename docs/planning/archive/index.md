...
Superseded planning documents. All gaps G1–G10 are closed. Proposals whose
deliverables landed are moved here to keep the active planning surface clean.

These documents are retained for historical reference only. Do not link to
them from active planning documents.

## Archived Proposals

Gap 5 (Event Lifecycle And Archival) — closed 2026-03-21:
...
- [Gap 5 Executive Delivery Roadmap](proposals/gap-5-executive-delivery-roadmap-20260319.md)
...
- [Gap 5 PR4 Redaction ADR Follow-Up](proposals/gap-5-pr4-redaction-adr-follow-up-20260319.md)
- [Gap 5 Sequence And Module Design](proposals/gap-5-sequence-and-module-design-20260319.md)

Gap 4 (Backpressure Admission) — closed 2026-03-26 (PR #628):
...
- [Gap 4 PR4 Operability — original](proposals/gap4-backpressure-admission-pr4-operability-20260319.md)
- [Gap 4 PR4 Implementation Plan](proposals/gap4-backpressure-admission-pr4-plan-20260326.md)
- [Gap 4 PR4 Plan B](proposals/gap4-backpressure-admission-pr4-planb-20260326.md)
- [Gap 4 PR5 Projected Read Model](proposals/gap4-backpressure-admission-pr5-projected-read-model-20260319.md)

RC tasks with closeouts:
...
- [RC-D1A Health Contract Compatibility And Watchdog](proposals/rc-d1a-health-contract-compat-and-watchdog-integration-20260323.md)
- [RC-D2 Outbox Claim Timeout Contract](proposals/rc-d2-claim-timeout-contract-20260323.md)
- [S15 Run Snapshot CAS Guard](proposals/s15-run-snapshot-cas-guard-20260322.md)

Superseded governance and roadmap proposals:
...
- [G5 US-G5.3 Correctness Hardening Plan](gaps/G5-US-G5.3-CORRECTNESS-HARDENING-PLAN.md)
...
- [GAP Parallel Execution Tracks](gaps/GAP_PARALLEL_EXECUTION_TRACKS.md)

## Archived Root Planning

- [DVT+ Top 5 Gaps (Corrected)](dvt-top-5-gaps-corrected-20260319.md)
- [Engine Gap-To-Target Migration Plan](engine-gap-to-target-migration-plan.md)
- [QA Architecture Findings And Risks](qa-architecture-findings-and-risks.md)
- [DVT Engine Spec Checklist Status](ENGINE_DVT_SPEC_CHECKLIST_STATUS.en.md)
