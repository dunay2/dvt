...
| G4-PR3 | Resilience Envelope     | Cache, circuit breaker, persisted fallback, multi-replica guardrails | G4-PR2     | Done        | [PR3](gap4-backpressure-admission-pr3-resilience-20260319.md)           |
