...
| [docs/planning/status/db-surface-inventory.md](./db-surface-inventory.md)                                                             | `navigation status`  | Stable pointer to the ignored DB-backed governance surface inventory render.             |
...
| [docs/planning/status/generated-knowledge-intake-literature.md](./generated-knowledge-intake-literature.md)                           | `navigation status`  | Stable pointer to the ignored DB-backed knowledge-intake literature render.              |
