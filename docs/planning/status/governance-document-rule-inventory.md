...
| `planning`      | GitHub Issues, `docs/planning/state/planning-control-tower.md`                 | sequencing, blockers, acceptance, or canonical planning posture changes                 | issue/PR evidence + `pnpm verify:prepush`                       |
...
| [docs/DOCS_README.md](../../DOCS_README.md)                                                                                 | `operational`                        | Documentation structure baseline   | Single canonical ADR location under `docs/adr/`; `index.md` in every directory; explicit document status; unique ADR IDs; move historical material to archive; GitHub Issues owns MVP task lifecycle.                                              |
...
| [docs/planning/state/planning-dashboard.md](../state/planning-dashboard.md)                                                 | `entrypoint`                         | Human planning dashboard           | Start here when the question is `what is active, blocked, or next`; use it to route to GitHub Issues, pull requests, Planning DB architecture queries, and roadmap surfaces.                                                                       |
...
| [docs/planning/state/planning-control-tower.md](../state/planning-control-tower.md)                                         | `entrypoint`                         | Planning navigation                | GitHub Issues owns MVP backlog and task lifecycle; Planning DB owns components, capabilities, relations, command/query rails, feature mechanization, and architecture evidence.                                                                    |
...
| `ADR-0055`  | Superseded | Former Planning DB task and governance authority, narrowed by ADR-0061                                          | [ADR-0055](../../adr/adr-0055-planning-db-canonical-operational-source.md)                        |
| `ADR-0061`  | Accepted   | GitHub task authority and Planning DB architecture/mechanization boundary                                       | [ADR-0061](../../adr/ADR-0061-github-mvp-task-authority-and-planning-db-architecture-boundary.md) |
| `ADR-0063`  | Accepted   | Planning DB has one current declarative schema and no migration compatibility or applied-state ledger           | [ADR-0063](../../adr/ADR-0063-planning-db-current-schema-rebuild.md)                              |
...
| [planning/status/generated-code-state.md](./generated-code-state.md)                                                                  | `generated status`   | On-demand code-state projection published from the ignored generator-owned artifact.     |
| [planning/status/db-surface-inventory.md](./db-surface-inventory.md)                                                                  | `generated status`   | On-demand DB-backed governance surface inventory; no tracked pointer copy.               |
...
| [planning/status/generated-knowledge-intake-literature.md](./generated-knowledge-intake-literature.md)                                | `generated status`   | On-demand DB-backed knowledge-intake literature; no tracked pointer copy.                |
