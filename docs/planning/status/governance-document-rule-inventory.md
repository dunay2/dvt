...
| `ADR-0054`  | Accepted   | Planning DB canonical operational source, DB-first commands, normalized read models, and export gates           | [ADR-0054](../../adr/adr-0054-planning-db-canonical-operational-source.md)                    |
