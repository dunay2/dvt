...
| `operational`       | How contributors and agents must work                          | [Contributing](../../CONTRIBUTING.md), [AI Work Protocol](../../guides/ai-work-protocol.md), [Testing and CI Capabilities](../../guides/testing-and-ci-capabilities.md)                         | process order, validation requirements, PR rules, local commands              |
...
| [AI Work Protocol](../../guides/ai-work-protocol.md)                                                                        | `operational`             | AI-assisted work must follow phased workflow: existing material check, think-first analysis, pre-implementation brief, baseline ADR validation, traceable generation, relationship recording, documentation update, validation and closeout.              |
...
9. [AI Work Protocol](../../guides/ai-work-protocol.md)
