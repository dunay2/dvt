...
Generated automatically from repository code on 2026-04-24.
...
| ---------------------------- | ----- |
| Total workspaces             | 24    |
| Total source files           | 1139  |
| Total test files             | 577   |
...
| ------------------------- | ------------------------------------ | --------- | ---------- | ----- | ---- | --------- | ----------------------- |
| dvt-api                   | `apps/api`                           | 195       | 141        | yes   | yes  | yes       | -                       |
...
| @dvt/web                  | `apps/web`                           | 484       | 184        | yes   | yes  | yes       | -                       |
