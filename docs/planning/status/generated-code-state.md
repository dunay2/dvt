...
Generated automatically from repository code on 2026-05-03.
...
| ---------------------------- | ----- |
| Total workspaces             | 24    |
| Total source files           | 1224  |
| Total test files             | 669   |
...
| ------------------------- | ------------------------------------ | --------- | ---------- | ----- | ---- | --------- | ----------------------- |
| dvt-api                   | `apps/api`                           | 202       | 158        | yes   | yes  | yes       | -                       |
...
| @dvt/web                  | `apps/web`                           | 529       | 228        | yes   | yes  | yes       | -                       |
