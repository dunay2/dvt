...
Generated automatically from repository code on 2026-04-15.
...
| ------------------------- | ------------------------------------ | --------- | ---------- | ----- | ---- | --------- | ----------------------- |
| dvt-api                   | `apps/api`                           | 145       | 64         | yes   | yes  | yes       | -                       |
...
| @dvt/web                  | `apps/web`                           | 309       | 78         | yes   | yes  | yes       | -                       |
