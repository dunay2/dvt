...
Generated automatically from repository code on 2026-05-09.
...
| ---------------------------- | ----- |
| Total workspaces             | 24    |
| Total source files           | 1264  |
| Total test files             | 693   |
...
| ------------------------- | ------------------------------------ | --------- | ---------- | ----- | ---- | --------- | ----------------------- |
| dvt-api                   | `apps/api`                           | 222       | 163        | yes   | yes  | yes       | -                       |
...
| @dvt/web                  | `apps/web`                           | 547       | 241        | yes   | yes  | yes       | -                       |
