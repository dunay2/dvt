...
Generated automatically from repository code on 2026-05-04.
...
| ---------------------------- | ----- |
| Total workspaces             | 24    |
| Total source files           | 1259  |
| Total test files             | 680   |
...
| ------------------------- | ------------------------------------ | --------- | ---------- | ----- | ---- | --------- | ----------------------- |
| dvt-api                   | `apps/api`                           | 223       | 162        | yes   | yes  | yes       | -                       |
...
| @dvt/web                  | `apps/web`                           | 543       | 235        | yes   | yes  | yes       | -                       |
