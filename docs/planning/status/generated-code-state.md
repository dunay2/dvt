...
Generated automatically from repository code on 2026-04-14.
...
| ------------------------- | ------------------------------------ | --------- | ---------- | ----- | ---- | --------- | ----------------------- |
| dvt-api                   | `apps/api`                           | 143       | 63         | yes   | yes  | yes       | -                       |
...
| @dvt/web                  | `apps/web`                           | 301       | 74         | yes   | yes  | yes       | -                       |
