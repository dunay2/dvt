...
Generated automatically from repository code on 2026-04-07.
...
| @dvt/web                  | `apps/web`                           | 264       | 45         | yes   | yes  | yes       | -                       |
...
| @dvt/engine               | `packages/@dvt/engine`               | 91        | 38         | yes   | yes  | no        | 34                      |
