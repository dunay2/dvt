...
| ------------------------- | ------------------------------------ | --------- | ---------- | ----- | ---- | --------- | ----------------------- |
| dvt-api                   | `apps/api`                           | 193       | 132        | yes   | yes  | yes       | -                       |
...
| @dvt/web                  | `apps/web`                           | 475       | 179        | yes   | yes  | yes       | -                       |
...
| @dvt/contracts            | `packages/@dvt/contracts`            | 74        | 25         | yes   | yes  | yes       | 48                      |
...
| @dvt/planner              | `packages/@dvt/planner`              | 23        | 18         | yes   | yes  | yes       | 14                      |
