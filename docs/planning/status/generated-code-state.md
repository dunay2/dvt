...
Generated automatically from repository code on 2026-05-05.
...
| ---------------------------- | ----- |
| Total workspaces             | 24    |
| Total source files           | 1260  |
| Total test files             | 682   |
...
| @dvt/traceability-service | `packages/@dvt/traceability-service` | 37        | 13         | yes   | yes  | yes       | 8                       |
