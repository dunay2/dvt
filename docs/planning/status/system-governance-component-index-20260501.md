...
| --- | ---: | --- |
| `SYS-DOCS-GOVERNANCE-ROOT` | 1745 | `coverage-required` |
...
| `SYS-REPO-METADATA-ROOT` | 117 | `canonical` |
...
| `SYS-DOCS-GOVERNANCE-ROOT` | `component` | `coverage-required` | `coverage-required` | `none` | `coverage-required` | 1745 | `INFRA` | `SYS-DOCS-GOVERNANCE` |
...
| `SYS-REPO-METADATA-ROOT` | `component` | `canonical` | `governed` | `implementation-owner` | `classification-only` | 117 | `INFRA` | `SYS-REPO-METADATA` |
