...
| --- | ---: | --- |
| `SYS-DOCS-GOVERNANCE-ROOT` | 1731 | `coverage-required` |
| `SYS-WEB-ROOT` | 820 | `coverage-required` |
...
| `SYS-DOCS-GOVERNANCE-ROOT` | `component` | `coverage-required` | `coverage-required` | `none` | `coverage-required` | 1731 | `INFRA` | `SYS-DOCS-GOVERNANCE` |
...
| `SYS-WEB-ROOT` | `component` | `coverage-required` | `coverage-required` | `none` | `coverage-required` | 820 | `ENTRY` | `SYS-WEB` |
