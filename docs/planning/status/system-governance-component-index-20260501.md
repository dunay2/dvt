...
| --- | ---: | --- |
| `SYS-DOCS-GOVERNANCE-ROOT` | 1647 | `coverage-required` |
...
| `SYS-CI-GOVERNANCE-ROOT` | 176 | `coverage-required` |
...
| `SYS-CI-GOVERNANCE-ROOT` | `component` | `coverage-required` | 176 | `INFRA` | `SYS-CI-GOVERNANCE` |
| `SYS-CONTRACTS-ROOT` | `component` | `coverage-required` | 127 | `PORT` | `SYS-CONTRACTS` |
| `SYS-DOCS-GOVERNANCE-ROOT` | `component` | `coverage-required` | 1647 | `INFRA` | `SYS-DOCS-GOVERNANCE` |
