...
| `SYS-CI-GOVERNANCE-ROOT` | 192 | `coverage-required` |
...
| `SYS-CI-GOVERNANCE-ROOT` | `component` | `coverage-required` | `coverage-required` | `none` | `coverage-required` | 192 | `INFRA` | `SYS-CI-GOVERNANCE` |
