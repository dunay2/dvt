...
| Workspace graph authoring draft persistence    | `@dvt/contracts`, `apps/api`, `apps/web`                                               | [Workspace authoring draft aggregate](../../architecture/components/planner/workspace-authoring-draft-aggregate.md), [Workspace graph draft persistence v1](../../contracts/planner/workspace-graph-draft-persistence-v1.md), [Workspace graph draft application component](../../../apps/api/docs/workspace-graph-draft-application-component.md) | [TF-A2 workspace authoring draft aggregate roots plan](../proposals/mandatory/runtime-and-contracts/tf-a2-workspace-authoring-draft-aggregate-roots-plan-20260423.md) |
...
- Verification:
  `pnpm --filter @dvt/contracts test -- workspace-graph-authoring-draft.contract.test.ts workspace-graph-authoring-draft.architecture.test.ts validation.test.ts`
  and
