...
| Governance component definition | `planning_query_store.governance_component_local_definitions` and `planning_query_store.governance_component_local_operations` for DB-authored component declarations; generated `governance_components` remains an imported projection                                                                                                                                                                                         | `pnpm planning:db:operate component create`                                                                                                                                                                                                                                                                                                                                                                                       | `pnpm planning:db:query component-tree --component <component_id>`, `pnpm planning:db:query component-metadata --component <component_id>`, `component_engineering.component_definition_query`                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                | Effective component definition rows and recursive unit tree rows                                                                             | `node --test scripts/planning-db-operate.test.cjs`, `node --test scripts/planning-db-migrate.test.cjs`, `pnpm test:planning:db`                                                                                                                                                                                                                                                                                                                                                                                        | DB-first          |
