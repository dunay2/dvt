...
- Rail name: `ReadArchitectureDesignAuthority`
  ...
  - Scope and auth: repo-local, read-only maintainer and CI inspection query
  - Write posture: migration bootstrap only in this slice; production design
    authoring remains blocked until the `CreateArchitectureDesign` command rail
    lands
