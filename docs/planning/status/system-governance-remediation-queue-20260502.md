...
| `GRQ-DOC_ALIGNMENT-SYS-DOCS-GOVERNANCE` | `P2` | `doc-alignment` | `SYS-DOCS-GOVERNANCE` | 0 | 262 | Documents track drift or require disposition and need alignment with active units. |
