...
| `GRQ-DOC_ALIGNMENT-SYS-DOCS-GOVERNANCE` | `P2` | `doc-alignment` | `SYS-DOCS-GOVERNANCE` | 0 | 267 | Documents track drift or require disposition and need alignment with active units. |
| `GRQ-DOC_ALIGNMENT-SYS-RUNTIME` | `P2` | `doc-alignment` | `SYS-RUNTIME` | 0 | 46 | Documents track drift or require disposition and need alignment with active units. |
