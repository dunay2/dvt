...
| --- | ---: | --- | --- |
| `SYS-DOCS-GOVERNANCE-ROOT` | 1761 | `coverage-required` | `INFRA` |
...
| `SYS-REPO-METADATA-ROOT` | 121 | `canonical` | `INFRA` |
...
| --- | ---: |
| `docs/DOCS_README.md` | 1776 |
| `docs/planning/status/governance-document-rule-inventory.md` | 1761 |
