...
| --- | ---: | --- | --- |
| `SYS-DOCS-GOVERNANCE-ROOT` | 1752 | `coverage-required` | `INFRA` |
...
| --- | ---: |
| `docs/DOCS_README.md` | 1767 |
| `docs/planning/status/governance-document-rule-inventory.md` | 1752 |
...
| `docs/guides/testing-and-ci-capabilities.md` | 348 |
