...
| `SYS-WEB-ROOT` | 803 | `coverage-required` | `ENTRY` |
...
| `docs/planning/proposals/mandatory/frontend-and-ux/f04-frontend-data-boundary-hexagonal-convergence-plan-20260403.md` | 803 |
