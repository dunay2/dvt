...
| Source connection            | User can create, test, authenticate, and audit data source connections                                               | Backend and UI expose governed warehouse connection create, test, list, and import rails                                                                                            | Needs end-to-end proof for credential audit, secret redaction, duplicate names, unsupported adapters, and failed audit writes |
...
- Remaining gap: end-to-end maturity evidence for credential audit, secret
  ...
  and failed audit write behavior.
