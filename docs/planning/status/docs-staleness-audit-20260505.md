...
| ---------------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------- |
| Legacy review location | Resolved: the former `docs/reviews/` files now live under `docs/planning/archive/reviews/` with historical archive metadata.                                               | Keep inbound links on the archive paths and validate docs after any follow-up rename.       |
