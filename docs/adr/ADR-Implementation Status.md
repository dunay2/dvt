...
| ADR-0012 Plan integrity ownership | 🟡 Partial | [`validateStartRunPreconditions()`](../../packages/@dvt/engine/src/core/WorkflowEngine.ts:1), [`PlanIntegrityValidator`](../../packages/@dvt/engine/src/security/planIntegrity.ts:1) | Validations exist; cross-adapter parity remains ongoing. |
