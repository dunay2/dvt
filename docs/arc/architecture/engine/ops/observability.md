...
**Status**: Phase 1 MVP  
**References**: [IWorkflowEngine](../contracts/engine/IWorkflowEngine.v1.1.md), [ExecutionSemantics](../contracts/engine/ExecutionSemantics.v1.md), [SLOs](./SLOs.md), [Severity Matrix](./runbooks/severity_matrix.md)
