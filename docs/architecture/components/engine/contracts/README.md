...
| engine       | [IProviderAdapter](./engine/IProviderAdapter.v1.1.md)                                          | v1.1    | ACTIVE    | Core      | [engine/IProviderAdapter.v1.1.md](./engine/IProviderAdapter.v1.1.md)                                                            |
...
| engine       | [Run Execution Policy](./engine/RunExecutionPolicy.v1.md)                                      | v1      | ACTIVE    | Core      | [engine/RunExecutionPolicy.v1.md](./engine/RunExecutionPolicy.v1.md)                                                            |
| engine       | [StartRun Protocol](./engine/StartRunProtocol.v1.md)                                           | v1      | ACTIVE    | Core      | [engine/StartRunProtocol.v1.md](./engine/StartRunProtocol.v1.md)                                                                |
...
| state-store  | [State Store Overview](./state-store/overview.md)                                              | n/a     | ACTIVE    | Core      | [state-store/overview.md](./state-store/overview.md)                                                                            |
| state-store  | [IRunStateStore (TypeScript)](../../../../../packages/@dvt/engine/src/ports/IRunStateStore.ts) | live    | ACTIVE    | Code      | [../../../../packages/@dvt/engine/src/ports/IRunStateStore.ts](../../../../../packages/@dvt/engine/src/ports/IRunStateStore.ts) |
| state-store  | [State Store Docs](./state-store/README.md)                                                    | n/a     | ACTIVE    | Index     | [state-store/README.md](./state-store/README.md)                                                                                |
...
| engine      | [IProviderAdapter (archived)](./engine/IProviderAdapter.v1.0.md)        | v1.0    | ARCHIVED  | Reference | [engine/IProviderAdapter.v1.0.md](./engine/IProviderAdapter.v1.0.md)               |
| state-store | [IRunStateStore](./state-store/IRunStateStore.v1.md)                    | v1      | DRAFT     | Reference | [state-store/IRunStateStore.v1.md](./state-store/IRunStateStore.v1.md)             |
| state-store | [IRunStateStore](./state-store/IRunStateStore.v2.0.md)                  | v2.0.0  | DRAFT     | Reference | [state-store/IRunStateStore.v2.0.md](./state-store/IRunStateStore.v2.0.md)         |
...
- For state-store, accepted ADRs and live TypeScript ports take precedence over
  older markdown contract snapshots.
