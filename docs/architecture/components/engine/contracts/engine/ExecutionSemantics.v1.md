...
[IWorkflowEngine Contract](./IWorkflowEngine.reference.v1.md)  
 ...
 [State Store Adapters](../../../../engine/adapters/state-store) - backend-specific implementations (Snowflake, Postgres, etc.)  
...
**Schema Location**: `docs/architecture/components/engine/contracts/engine/events/*.schema.json`
