...
- Docs, runbook, proposal, user stories, canonical Fowler mechanization, and
  semantic test must name the same rails.
...
generated artifacts runbook, original extraction proposal, and canonical
Fowler mechanization tokens exist together and name the same rails.
...
- [Autogenerated Pages Mailbox Analysis](https://github.com/dunay2/dvt/blob/2df68680de46b9104282a58fd203a7eef551ca38/buzon/20260524-codex-fowler-autogenerated-pages-canon.md)
