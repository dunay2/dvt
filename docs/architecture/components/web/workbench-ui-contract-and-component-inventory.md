...
| `LeftNavigationRail`                                                         | [`LeftNavigation.tsx`](../../../../apps/web/src/app/components/LeftNavigation.tsx) plus shell navigation model under `apps/web/src/app/shell/*`                     | Reuse plugin-aware routing logic   | rail rendering is clean, but a reusable shell frame contract is still implicit at `Root` |
