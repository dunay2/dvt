...
| `RouteWorkbenchFrame`                                                        | Shared frame already adopted by the `Code`, `Diff`, `Lineage`, `Artifacts`, and `Admin` routes                                                                      | Reuse within the v1 frame contract | side panels, shared route toolbars, and richer shell extraction remain future primitives            |
