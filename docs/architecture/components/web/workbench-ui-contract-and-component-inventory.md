...
| `Lineage panel tokens`                                                       | [`lineageChromeTokens.ts`](../../../../apps/web/src/app/views/lineage/lineageChromeTokens.ts)                                                                       | Reuse within Lineage route panels              | broader React Flow palette and Monaco visual hardening remain under F-24                 |
