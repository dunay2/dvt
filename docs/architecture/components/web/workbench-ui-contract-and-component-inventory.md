...
| `Lineage panel tokens`                                                       | [`lineageChromeTokens.ts`](../../../../apps/web/src/app/views/lineage/lineageChromeTokens.ts)                                                                       | Reuse within Lineage route panels              | Monaco visual hardening remains under F-24                                               |
| `React Flow graph visual tokens`                                             | [`graphVisualTokens.ts`](../../../../apps/web/src/app/plugins/graph/graphVisualTokens.ts)                                                                           | Reuse within Canvas and plugin graph rendering | broader context-panel and Monaco visual-system hardening remain under F-24/F-25          |
