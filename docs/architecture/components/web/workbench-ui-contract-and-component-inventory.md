...
| `ShellTopBar`                                                                | [`TopAppBar.tsx`](../../../../apps/web/src/app/components/TopAppBar.tsx)                                                                                            | Reuse core behavior                | tokenized shell chrome now exists, but mixed shell controls still live in one component             |
...
| `LeftNavigationRail`                                                         | [`LeftNavigation.tsx`](../../../../apps/web/src/app/components/LeftNavigation.tsx)                                                                                  | Reuse plugin-aware routing logic   | icon-only rail now uses governed shell tokens, but capability-query ownership still needs hardening |
