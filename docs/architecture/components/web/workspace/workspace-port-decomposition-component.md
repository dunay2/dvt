...
| `IWarehouseSourceImportPort`       | web command/query port | `ListWarehouseConnections`, `ListWarehouseConnectionTables`, `ImportWarehouseSources` | Discover and import warehouse source metadata through protected runtime warehouse source-import rails.                  |
