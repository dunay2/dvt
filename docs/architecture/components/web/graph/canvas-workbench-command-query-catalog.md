...
| Boundary drift: DVT source, Transform, and sink config could be absent until preview failed.                      | `ConfigureCanvasDvtNode` keeps writable DVT preview metadata in route authoring before artifact generation.                                                                             | DTO plus Command seam.                   |
