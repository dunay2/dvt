...
- use `canvas-authoring-runtime-component.md` for the authoring-runtime
  contract, baseline seam, draft-flow seam, and runtime invariants
...
- use `canvas-route-composition-component.md` for route orchestration, modal
  adaptation, and concern-scoped shell-builder contracts
...
| ---------------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ----------------------------------------------------------------------------------------- |
| Route entry and presentation | [Canvas.tsx](../../../../../apps/web/src/app/views/Canvas.tsx), [useCanvasRoutePresentationSync.ts](../../../../../apps/web/src/app/views/canvas/useCanvasRoutePresentationSync.ts), [CanvasModalHost.tsx](../../../../../apps/web/src/app/views/canvas/CanvasModalHost.tsx), [canvasModalHostPropsBuilder.ts](../../../../../apps/web/src/app/views/canvas/canvasModalHostPropsBuilder.ts), [canvasShellPropsBuilder.tsx](../../../../../apps/web/src/app/views/canvas/canvasShellPropsBuilder.tsx), [canvasShellBuilder.types.ts](../../../../../apps/web/src/app/views/canvas/canvasShellBuilder.types.ts), [CanvasCenterSurface.tsx](../../../../../apps/web/src/app/views/canvas/CanvasCenterSurface.tsx), [CanvasRecoveryBanner.tsx](../../../../../apps/web/src/app/views/canvas/CanvasRecoveryBanner.tsx), [canvasRouteViewState.ts](../../../../../apps/web/src/app/views/canvas/canvasRouteViewState.ts), [canvasDraftPresentationModel.ts](../../../../../apps/web/src/app/views/canvas/canvasDraftPresentationModel.ts), [canvasToolbarViewModel.ts](../../../../../apps/web/src/app/views/canvas/canvasToolbarViewModel.ts) | Route-facing UI adapters, route-safe presentation state, and route-owned adaptation seams |
...
| Query and projection seams   | [canvasAuthoringGraphProjection.ts](../../../../../apps/web/src/app/views/canvas/canvasAuthoringGraphProjection.ts), [useCanvasAuthoringProjection.ts](../../../../../apps/web/src/app/views/canvas/useCanvasAuthoringProjection.ts), [useCanvasViewportGraphModel.ts](../../../../../apps/web/src/app/views/canvas/useCanvasViewportGraphModel.ts), [useCanvasControllerReadModel.ts](../../../../../apps/web/src/app/views/canvas/useCanvasControllerReadModel.ts), [useCanvasCurrentDraftPayload.ts](../../../../../apps/web/src/app/views/canvas/useCanvasCurrentDraftPayload.ts), [useCanvasOverlayModel.ts](../../../../../apps/web/src/app/views/canvas/useCanvasOverlayModel.ts)                                                                                                                                                                                                                                                                                                                                                                                                                                                 | Read-side projections and route models                                                    |
...
| Read models and repositories | `canvasAuthoringGraphProjection.ts`, `useCanvasAuthoringProjection.ts`, `useCanvasViewportGraphModel.ts`, `useCanvasControllerReadModel.ts`, `useCanvasCurrentDraftPayload.ts`, `canvasDraftRepository.ts`, `canvasDraftReadModel.ts` | Projection, route presentation state, persistence boundary translation | Semantic authority over authoring truth                  |
...
flowchart LR
  ...
  Projection --> AuthoringGraph["canvasAuthoringGraphProjection"]
  Projection --> ViewportGraph["useCanvasViewportGraphModel"]
...
- `useCanvasController` is already a facade, but not yet a fully settled thin
  one
- `useCanvasAuthoringRuntime` is still the heaviest command seam, but it now
  has an explicit local contract instead of type-coupling through the parent
  hook
...
1. `useCanvasAuthoringRuntime.ts` still coordinates too much in one place, even
   after the local contract extraction.
...
flowchart LR
  ...
  Query --> Projection["canvasAuthoringGraphProjection / useCanvasViewportGraphModel / useCanvasControllerReadModel / useCanvasOverlayModel"]
...
- semantic projections answer authoring-truth questions, viewport projections
  answer React Flow questions, and commands do not blur those concerns
