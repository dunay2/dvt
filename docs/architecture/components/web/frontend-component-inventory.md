...
| `web.component.shell.LeftNavigationRail.source`            | `web.component.shell.LeftNavigationRail`      | documentation     | `docs/architecture/components/web/screen-manuals-and-user-stories.md`                      | accepted        |
| `web.component.shell.BottomOperationalDrawer.docs`         | `web.component.shell.BottomOperationalDrawer` | documentation     | `docs/architecture/components/web/screen-manuals-and-user-stories.md`                      | accepted        |
...
| `web.component.workbench.WorkbenchStates.docs`             | `web.component.workbench.WorkbenchStates`     | documentation     | `docs/architecture/components/web/screen-manuals-and-user-stories.md`                      | accepted        |
