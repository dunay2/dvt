...
| `web.component.shell.ShellTopBar`             | `LoadRuntimeCapabilities`               | query   | `LoadRuntimeCapabilities`               | query       | implemented-api        | Runtime capabilities read model            |
...
| `web.component.canvas.CanvasContextMenu`      | `PreviewExecutablePlan`                 | command | `PreviewExecutablePlan`                 | command     | implemented-api        | Execution plan preview application service |
...
| `web.component.canvas.SourceImportDialog`     | `ListWarehouseConnectionTables`         | query   | `ListWarehouseConnectionTables`         | query       | implemented-api        | Warehouse table read model                 |
...
| `web.component.canvas.SourceImportDialog.browser-proof`    | `web.component.canvas.SourceImportDialog`     | e2e-test          | `apps/web/cypress/e2e/canvas/canvas-source-import-contextual.cy.ts`                        | accepted        |
