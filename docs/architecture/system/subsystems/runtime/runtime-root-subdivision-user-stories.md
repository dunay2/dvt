...
| ---------- | ---------------------------------------------------------------------------------------------------------------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------ |
| RT-SUB-001 | As an architect, I can query a runtime file and see the exact component that owns it.                                  | `@dvt/engine`, `@dvt/state-store`, `@dvt/delivery`, `@dvt/run-domain`, `@dvt/plan-interpreter`, `@dvt/plan-verifier`, `@dvt/canonical`, `@dvt/dsl`, and `@dvt/cli` files map to specific runtime component IDs. | `node --test scripts/check-governance-unit-coverage.test.cjs`                  |
