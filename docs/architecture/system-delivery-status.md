...
- [Execution Workboard](../planning/state/execution-workboard.md) for the active
  task and lane posture
...
| Execution layer            | Partial            | engine, Postgres adapter, and Temporal adapter are implemented; delivery runtime ownership is now extracted into `@dvt/delivery`, while scheduler and further hardening remain active follow-up work                                                                                                                                                                                                                                                                                                                                                                                      | [Execution Runtime](../planning/domains/execution-runtime.md), [Execution Workboard](../planning/state/execution-workboard.md)                                                    |
...
2. [Execution Workboard](../planning/state/execution-workboard.md)
