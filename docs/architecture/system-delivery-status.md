...
| Web UI     | `apps/web` | Partial            | Client shell and routing exist; a small targeted test set now covers canvas behavior, workspace import behavior, and a narrow runs surface, but coverage remains limited and mock-heavy capability paths still dominate                                                                                                                                                                                                                                                                                                                                                                                                                                |
