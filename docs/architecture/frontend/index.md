...
12. [Frontend Runtime Contract Technical Manual](runs/frontend-runtime-contract-technical-manual.md)
13. [Frontend Runtime Contract User Manual](runs/frontend-runtime-contract-user-manual.md)
14. [Lineage](lineage/dvt-frontend-lineage.md)
15. [Git Mode Architecture](git/git-mode-architecture.md)
16. [Frontend Observability Architecture](observability/front-observability-architecture-dvt.md)
17. [Frontend Artifacts](artifacts/front-artifacts.md)
18. [apps/web](../components/web-app/index.md)
19. [@dvt/web package surface](../components/web/index.md)
