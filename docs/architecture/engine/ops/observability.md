...
**Status**: Phase 1 MVP  
**References**: [IWorkflowEngine](../contracts/engine/IWorkflowEngine.v1.md), [ExecutionSemantics](../contracts/engine/ExecutionSemantics.v1.md), [SLOs](./SLOs.md), [Severity Matrix](./runbooks/severity_matrix.md)
...
dvt_signals_received_total{signal_type, status} = counter
  signal_types: [PAUSE, RESUME, CANCEL, RETRY_RUN, CUSTOM_1, ...]
