...
**References**: [IWorkflowEngine Contract](../../contracts/engine/IWorkflowEngine.v1.1.md), [Temporal SDK](https://docs.temporal.io/develop/typescript), [Temporal Platform Limits](https://docs.temporal.io/encyclopedia/temporal-platform-limits)
