...
**Status**: Normative alias (single source of truth preserved)
...
- [RunEvents.v1.1.md](./RunEvents.v1.1.md)
...
- Event type enumeration → [RunEvents.v1.1.md §1.1](./RunEvents.v1.1.md)
- Required fields per event → [RunEvents.v1.1.md §2.1](./RunEvents.v1.1.md)
- State transition table → [RunEvents.v1.1.md §3](./RunEvents.v1.1.md)
- Illegal transitions / terminal-state protections → [RunEvents.v1.1.md §3](./RunEvents.v1.1.md)
- Idempotency rules and collision behavior → [RunEvents.v1.1.md §2.2](./RunEvents.v1.1.md)
- Versioned event envelope schema → [RunEvents.v1.1.md §4](./RunEvents.v1.1.md)

---

## Governance rule

- `RunEvents.v1.1.md` MUST remain the only normative body for run-event semantics.
