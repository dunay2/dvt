...
| -------- | ------------------------------------------------------- | -------- | ---------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| ADR-0000 | Normative traceability for generated code and artifacts | Accepted | 2026-02-16 | [`ADR-0000-Generación de código con trazabilidad normativa obligatoria.md`](./ADR-0000-Generación%20de%20código%20con%20trazabilidad%20normativa%20obligatoria.md) |
