...
- [Canonical contract registry](./contracts/README.md)
- [Canonical security docs](./security/THREAT_MODEL.md)
- [Canonical operations docs](./ops/observability.md)

## Maintenance rule

If a topic already has a canonical home under
`docs/architecture/components/engine/`, link to that page instead of
rebuilding local structure notes, local C4 diagrams, or delivery-gap scratch
packs in this subtree.
