...
| `@dvt/web`          | UI shell, graph canvas, run monitoring, client routing                          | [web component](../architecture/components/web/index.md), [Read subsystem](../architecture/subsystems/read/index.md), [apps/web/FRONTEND_PLAN_BACK_ALIGNMENT.md](../../apps/web/FRONTEND_PLAN_BACK_ALIGNMENT.md) | `linked-local` |
...
| `@dvt/engine`               | Core workflow execution and orchestration                     | [@dvt/engine](../architecture/components/engine/index.md), [Execution subsystem architecture](../architecture/engine/index.md), [Canonical Doc Code Matrix](../planning/status/canonical-doc-code-matrix.md) | `canonical`    |
