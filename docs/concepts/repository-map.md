...
| `@dvt/adapter-temporal`     | Temporal provider runtime and worker host                     | [Temporal Adapter Specification](../architecture/components/engine/adapters/temporal/TemporalAdapter.spec.md), [Canonical Doc Code Matrix](../planning/status/canonical-doc-code-matrix.md)                             | `canonical`    |
