...
- [Access-decision vocabulary and capability-policy ownership can drift across API and contracts surfaces](R-20260423-ACCESS-DECISION-VOCABULARY-HARDENING.yaml)
