...
- [Function consumers could misread open Substrait invocation arity](R-20260911-SUBSTRAIT-VARIADIC-ARITY-DRIFT.yaml)
...
- [Persisted terminal Transform Preview may outlive executor capability posture](R-20260911-TERMINAL-TRANSFORM-PREVIEW.yaml)
...
- [Temporal SDK 1.24 could change worker or replay behavior](R-20260925-TEMPORAL-SDK-1-24-UPGRADE.yaml)
...
- [Unary JOIN null predicates must preserve arity and null semantics](R-20260913-JOIN-NULL-PREDICATES.yaml)
