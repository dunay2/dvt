...
- [Provider ref updates discard explicit empty optional values](R-20260409-PROVIDER-REF-EMPTY-STRING-PERSISTENCE.yaml)
...
- [R 20260330 Snapshot Staleness Caller View](R-20260330-snapshot-staleness-caller-view.yaml)
- [R 20260330 STALENESS PARALLEL TELEMETRY ON ENGINE FAILURE](R-20260330-STALENESS-PARALLEL-TELEMETRY-ON-ENGINE-FAILURE.yaml)
- [R 20260330 WS5 ENGINE TEST FIXTURE DRIFT](R-20260330-WS5-ENGINE-TEST-FIXTURE-DRIFT.md)
- [R 20260331 MANIFESTREF PRODUCTION PATH](R-20260331-MANIFESTREF-PRODUCTION-PATH.yaml)
- [R 20260331 PLANNER DETERMINISM HASH DRIFT](R-20260331-PLANNER-DETERMINISM-HASH-DRIFT.yaml)
- [R 20260331 RC C1 BOUNDARY LEGACY HARDENING](R-20260331-RC-C1-BOUNDARY-LEGACY-HARDENING.yaml)
- [R 20260401 ADMISSION TELEMETRY TEARDOWN RESILIENCE](R-20260401-ADMISSION-TELEMETRY-TEARDOWN-RESILIENCE.yaml)
- [R 20260401 EXECUTION PLAN IDENTITY DRIFT](R-20260401-EXECUTION-PLAN-IDENTITY-DRIFT.yaml)
- [R 20260401 TEMPORAL LIVE STATUS QUERY](R-20260401-TEMPORAL-LIVE-STATUS-QUERY.yaml)
- [R 20260402 RC G1 CONTRACT OWNERSHIP EXECUTION DRIFT](R-20260402-RC-G1-CONTRACT-OWNERSHIP-EXECUTION-DRIFT.yaml)
- [R 20260402 S05 ENVELOPE BOUNDARY GATING](R-20260402-S05-ENVELOPE-BOUNDARY-GATING.yaml)
- [R 20260403 TSCONFIG BASEURL DEPRECATION MIGRATION](R-20260403-TSCONFIG-BASEURL-DEPRECATION-MIGRATION.yaml)
- [R 20260407 ENGINE ENTRYPOINT PLAN PAYLOAD](R-20260407-ENGINE-ENTRYPOINT-PLAN-PAYLOAD.yaml)
...
- [R-20260330-S19F1-SNAPSHOT-WORK-QUEUE-CLAIM-SEMANTICS](R-20260330-S19F1-SNAPSHOT-WORK-QUEUE-CLAIM-SEMANTICS.yaml)
- [R-20260403-CONTRACT-ERROR-SEMANTIC-DRIFT](R-20260403-CONTRACT-ERROR-SEMANTIC-DRIFT.yaml)
- [R-20260404-GUARDS-ALIGNMENT](R-20260404-guards-alignment-adapter-postgres.yaml)
- [R-20260408-PR807-ADAPTER-POSTGRES-TEST-CONTRACT-DRIFT](R-20260408-PR807-ADAPTER-POSTGRES-TEST-CONTRACT-DRIFT.yaml)
