...
- docs/architecture/engine/security/SECURITY_INVARIANTS.v1.md (translated, links reviewed)
- docs/architecture/engine/security/THREAT_MODEL.md (translated, links reviewed)

## Notes

- All links in documentation reference the new English filenames to avoid breaking navigation.
- All files listed are now translated; links have been reviewed for integrity.
- If you rename files, update all references in index.md and navigation files accordingly.

---

Generated automatically by reviewing the docs/ directory and translation status.
