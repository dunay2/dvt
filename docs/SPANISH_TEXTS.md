...
| [Execution State](https://github.com/dunay2/dvt/blob/7bb1b3e39efaf8df701db02dbdf2b10c763cfd28/docs/planning/execution-model/execution-state.md) | Rewritten in English and cleaned up duplicate frontmatter.                                                          |
| [Handbook State](https://github.com/dunay2/dvt/blob/7bb1b3e39efaf8df701db02dbdf2b10c763cfd28/docs/planning/execution-model/handbook-state.md)   | Rewritten in English and cleaned up duplicate frontmatter.                                                          |
