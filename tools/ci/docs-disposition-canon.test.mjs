...
test('retired documentation-only closeouts have no files or local consumers', () => {
  ...
  const editorialCloseouts = new Set([
    ...
    '20260414-shell-chrome-signal-compaction-closeout.md',
    ...
    '20260514-f04-parent-acceptance-closeout.md',
    '20260514-f05-store-domain-ownership-closeout.md',
    '20260522-f25-plugin-ux-contract-closeout.md',
    'G7.1-closeout.md',
    'engine-deps-refactor-closeout.md',
    'f-04-risk-a-qa-03-backend-owned-planref-closeout.md',
    'f-04-risk-b-mock-workspace-isolation-closeout.md',
