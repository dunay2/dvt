-- Keep the active Canvas source import dialog feature rail anchored to a
-- governed frontend source after post-import symbol restoration.
...
set
  ...
  implementation_refs = jsonb_build_array(
    ...
    'tools/planning-db/migrations/267_repoint_canvas_source_import_dialog_active_rail_source.sql'
  ),
  ...
  source_path = 'apps/web/src/app/views/canvas/CanvasShell.tsx',
  source_content_sha256 =
    md5('DVT-CANVAS-UXDB-SOURCE-DIALOG-1:OpenCanvasSourceImportDialog:CanvasShell')
    || md5('267_repoint_canvas_source_import_dialog_active_rail_source'),
  raw_rail = raw_rail || jsonb_build_object(
    'status', 'implemented',
    'sourcePath', 'apps/web/src/app/views/canvas/CanvasShell.tsx',
    'currentImplementationSourcePath', 'apps/web/src/app/views/canvas/CanvasShell.tsx'
  ),
  raw_manifest = raw_manifest || jsonb_build_object(
    'featureId', 'DVT-CANVAS-UXDB-SOURCE-DIALOG-1',
    'mechanizationStatus', 'implemented',
    'implementationPlan', 'apps/web/src/app/views/canvas/CanvasShell.tsx',
    'currentImplementationSourcePath', 'apps/web/src/app/views/canvas/CanvasShell.tsx',
    ...
    '267_repoint_canvas_source_import_dialog_active_rail_source'
  ),
  revision = revision + 1,
  updated_at = now()
where feature_id = 'DVT-CANVAS-UXDB-SOURCE-DIALOG-1'
  and rail_type = 'command'
  and normalized_rail_name = 'opencanvassourceimportdialog';
