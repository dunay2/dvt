drop view if exists component_engineering.component_roadmap_query;
drop view if exists planning_query_store.component_roadmap_query;
...
values (
  ...
  'DB read model for implemented, declared, and planned component gap inspection',
