-- Keep component-integrity independent from the full component-quality rule
-- rollup. component-quality remains the deep diagnostic rail; this view only
-- needs test-count evidence and component authority facts.
...
values (
  'PLANNING-DB-COMPONENT-INTEGRITY-QUALITY-LITE-20260618',
  'PLANNING-DB-COMPONENT-INTEGRITY-VOCABULARY-RAIL-20260612',
  'Planning DB component integrity quality-lite projection',
  'Architecture / Planning DB',
  'review',
  'component-integrity validates baseline blockers and progressive component debt. It must not depend on the full component-quality rule rollup, because that rail is an analysis query with expensive rule evaluation. This migration derives the needed test-count evidence from file ownership and leaves deep quality diagnostics on component-quality.',
  'evolutionary_architecture',
  'CheckPlanningDbComponentIntegrity;QueryComponentQuality',
  now()
)
