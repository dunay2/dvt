-- Restore the effective Canvas node workbench panel authority after governance
-- imports reintroduced the old deprecated duplicate-resolution rows. The real
-- owned surface is now CanvasNodeWorkbenchPanel.tsx plus its focused tests.
